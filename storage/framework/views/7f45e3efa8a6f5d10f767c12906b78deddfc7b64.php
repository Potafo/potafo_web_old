...
<script src="<?php echo e(asset('public/assets/script/jquery.js')); ?>" type="text/javascript"></script>
<script src="<?php echo e(asset('public/assets/js/jquery.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/angular.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/modernizr.custom.js')); ?>"></script>
...
<div class="container" id="divID" ng-controller="myCtrl">
   ...
   <div class="login_top_header">
        <span><img src="<?php echo e(asset('public/assets/images/comp_logo.png')); ?>" /></span>
    </div>

    <div  >
    <form class="form-horizontal simform" method="POST" action="<?php echo e(route('login')); ?>"  >
 <?php echo e(csrf_field()); ?>
     ...
     <?php echo Form::open(['url'=>'userexistcheck
        ...
        <div class="simform-inner">
            ...
            <div class="loader_img" id="loginloader">
                <img src="<?php echo e(asset("public/assets/images/ajax-loader.gif")); ?>">
            </div>
...
<div class="paymnet_section_alert_popup_cc paymnet_alert" id="paymnet_alert" style="display:none">
    <div class="paymnet_section_alert_popup">
        <div class="paymnet_section_alert_popup_head_img"><img src="<?php echo e(asset ('public/assets/images/alert-ico.png')); ?>"></div>
...
<script src="<?php echo e(asset('public/assets/js/classie.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/angular/app.js')); ?>"></script>
<script src="<?php echo e(asset('public/assets/js/stepsForm.js')); ?>"></script>
