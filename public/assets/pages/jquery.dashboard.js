...
!function($) {
    ...
    Dashboard1.prototype.init = function() {
        ...
        this.createStackedChart('morris-bar-stacked', $stckedData, 'y', ['a', 'b', 'c'], ['Dine in', 'Take Away', 'Counter sales'], ['#f5351b', '#5d9cec', '#ebeff2']);
        ...
        this.createAreaChartDotted('morris-area-with-dotted', 0, 0, $areaDotData, 'y', ['a', 'b', 'c'], ['Dine in', 'Take Away ', 'Counter sales   '],['#ffffff'],['#999999'], ['#f5351b', '#5d9cec','#ebeff2']);
