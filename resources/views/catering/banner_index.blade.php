@extends('layouts.app')
@section('title','Potafo - Manage Category Banners')
@section('content')
    <style>
        ...
        <div class="card-box table-responsive" style="padding: 8px 10px;">
            ...
            <div class="box master-add-field-box" >
                <div class="col-md-6 no-pad-left">
                    <h3>Manage Category Banners</h3>
                </div>

                <div class="col-md-3 no-pad-left pull-right">
                    <div class="table-filter" style="margin-top: 4px;">
                        <div class="table-filter-cc">
                            <a href="{{ url('catering/banner_app_add') }}"> <button type="submit" style="margin-left:0" class="on-default followups-popup-btn btn btn-primary" >Add App Banner</button></a>
                ...
                <table id="example1" class="table table-striped table-bordered">
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td style="min-width:150px;">
                            <a class="btn tbl_view_sec_btn" rel="popover" data-img="@if(isset($item->app_banner) && $item->app_banner != ''){{  $siteUrl.$item->app_banner }}@endif"  style="text-decoration: underline;cursor:pointer;">View</a>
                        ...
                        <td style="min-width:50px;">
                            <input class="form-control" type="textbox" onkeypress="return isNumberKey(event)" value="{{ $item->display_order }}" title="Edit Order" name="order_no" id="order_no" onkeyup="return changeorderno('{{ $item->id }}',this.value)">
                        </td>
...
@section('jquery')
    <script type="text/javascript">
        ...
        function changeorderno(id,val)
        {
            $.ajax({
                method: "get",
                url: "api/cat_banner_order/" + id+ "/"+val,
                cache: false,
                crossDomain: true,
                async: false,
                dataType: 'text',
