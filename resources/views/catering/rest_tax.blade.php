@extends('layouts.app')
@section('title','Manage Catering Tax')
@section('content')
<?php
...
.add-work-done-poppup-textbox-box label{font-weight:lighter;}.inner-textbox-cc input:focus ~ label, input:valid ~ label{font-size:13px;top: -10px;}.group{margin-bottom: 14px}.add-work-done-poppup{height: auto;} div.dataTables_wrapper div.dataTables_filter{float: right;top: 4px;position: relative;}.dataTables_length{top: 7px;position: relative;float: left}
    ...
    <div class="col-sm-12">
        ...
        <div class="col-sm-12">
           <a href="{{ url('cat_restaurant_edit/'.$resid) }}"><div class="potafo_top_menu_sec">About</div></a>
            <a href="{{ url('menu/types/'.$resid) }}"><div class="potafo_top_menu_sec ">Type</div></a>
            <a href="{{ url('cat_restaurant_category/'.$resid) }}"><div class="potafo_top_menu_sec ">Category</div></a>
            <a href="{{ url('cat_restaurant_pincode/'.$resid) }}"><div class="potafo_top_menu_sec ">Pincode</div></a>
        ...
        <div class="card-box table-responsive" style="padding: 8px 10px;">
            ...
            <table id="example1" class="table table-striped table-bordered">
                ...
                <tbody  style="height:390px">
                            ...
                            <tr>
                            <td style="text-align: left;width:7%">{{ $value->crt_slno }}</td>
                            <td style="text-align: left;width:10%">{{ $value->crt_name}}</td>
                            <td style="text-align: left;width:10%">{{ $value->crt_value}}</td>
                            
                            <td style="text-align: left;width:7%">
                                        <div class="status_chck{{ $value->crt_slno}}">
                                            <div class="onoffswitch">
                                                <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch{{$value->crt_rest_id}},{{$value->crt_slno}}" @if( $value->crt_status == 'Y') checked @endif>
                                                <label class="onoffswitch-label" for="myonoffswitch{{$value->crt_rest_id}},{{$value->crt_slno}}">
                                                    <span class="onoffswitch-inner" onclick="return  statuschange('{{$value->crt_rest_id}}','{{$value->crt_slno}}')"></span>
                                                    <span class="onoffswitch-switch" onclick="return  statuschange('{{$value->crt_rest_id}}','{{$value->crt_slno}}')"></span>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <td style="text-align: left;width:13%">
                                <a onclick="return taxedit('{{$value->crt_rest_id}}','{{$value->crt_slno}}','{{$value->crt_name}}','{{ $value->crt_value }}','{{ $value->crt_status }}')" class="btn button_table clear_edit" >               
                                    <i class="fa fa-pencil"></i>
                                </a>
                               <!-- <a style="cursor:pointer;" onclick="return view_all_category('{{$value->crt_rest_id}}','{{$value->crt_name}}','{{$value->crt_slno}}')" style="margin-right: 7px; float: right;">
