                ...
                <tbody  style="height:390px">
                            ...
                            @foreach($rows as $value)
                                <tr>
                                    ...
                                    <td style="text-align: left;width:10%">{{ $value->designation}}</td>
                                    <td style="text-align: left;width:7%">
                                        {{--@if( $value->active == 'Y') Active  @else  Inactive @endif--}}
                                        <div class="status_chck{{ $value->id}}">
                                            <div class="onoffswitch">
                                                <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myonoffswitch{{$value->id}}" @if( $value->active == 'Y') checked @endif>
                                                <label class="onoffswitch-label" for="myonoffswitch{{$value->id}}">
                                                    <span class="onoffswitch-inner" onclick="return  statuschange('{{$value->id}}')"></span>
                                                    <span class="onoffswitch-switch" onclick="return  statuschange('{{$value->id}}')"></span>
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <td style="text-align: left;width:10%">
                                        <a onclick="return designationedit('{{$value->id}}','{{$value->designation}}','{{$value->active}}')" class="btn button_table clear_edit" >               
                            ...
                            <div class="main_inner_class_track ">
                                <div class="group">
                                    <div style="position: relative">
                                       ...
                                       {!! Form::text('designation',null, ['class'=>'form-control','id'=>'designation','name'=>'designation','onkeypress' => 'return charonly(event);','required','style'=>"background-color:transparent;"]) !!}
                           ...
                           <div class="col-xs-3 main_inner_class_track">
                            <div class="form-group" id="status_p" style="display: none">
                             ...
                             <div class="box-footer">
                                 ...
                                 <a id="inserting" name="inserting"  class="staff-add-pop-btn staff-add-pop-btn-new" onclick="submit_designation('insert');">Submit</a>
                               <a id="updating" name="updating"  class="staff-add-pop-btn" onclick="submit_designation('update');" style="height:40px; bottom: 20px;">Update</a>
                              </div>
                        </div>
            ...
            <div class="add-work-done-poppup-contant" >
                ...
                <div class="add-work-done-poppup-textbox-cc">
                    <div class="add-work-done-poppup-textbox-box">
                        ...
                        <div class="main_container_track_order_list inner-textbox-cc" style="margin-top:10px;margin-bottom:0">
                            {!! Form::open(['enctype'=>"multipart/form-data",'id' =>'frm_reset','name' => 'frm_reset', 'ng-submit'=>'staffmaster()', 'ng-controller'=>'DesignationController']) !!}
...
<script>
        ...
        function submit_designation(type)
        {
            ...
            if(designation == '') {
            $("#designation").focus();
             $.Notification.autoHideNotify('error', 'bottom right','Enter Designation.');
            return false;
        }
      
        if(true)
        {
            var data= {"designation":designation,"status":status,"type":type,"userid":userid};
            $.ajax({
                method: "post",
        ...
        function designationedit(id,designation,status)
        {
         $("#userid").val(id);
         $("#status").val(status);
