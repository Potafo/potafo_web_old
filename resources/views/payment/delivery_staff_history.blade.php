    ...
    <div class="col-sm-12">
        ...
        <div class="card-box table-responsive" style="padding: 8px 10px;">
            <div class="box master-add-field-box" >
                ...
                <h3>DELIVERY STAFF PAYMENT HISTORY - {{$designation}}</h3>
                ...
                <div class="main_inner_class_track" style="width: 20%;">
                    <div class="group">
                       <div style="position: relative">
                            ...
                            <input id="staffname"  name="staffname" class="form-control" type="text" onkeyup="load_payhistorylist()">
                        </div>
                  ...
                  <div class="main_inner_class_track" style="width: 20%;margin-left: 10px">
                    <div class="group">
                       <div style="position: relative">
                            <label>Date</label>
                            <input id="date_pay" data-date-format='dd-mm-yyyy'  name="date_pay" class="form-control" type="text" onchange="load_payhistorylist()">
                        </div>
                  ...
                  <div class="main_inner_class_track" style="width: 20%;margin-left: 10px">
                    <div class="group">
                       <div style="position: relative">
                            ...
                            <select name="tranc_typefil"  id="tranc_typefil" class="form-control" onchange="load_payhistorylist()">
    ...
    <div id="add_cashdetails" class="add-work-done-poppup-cc" style="display: none;">
        <div class="add-work-done-poppup">
            ...
            <div style="text-align:center;" >
                <b>Final Amount : <span id="cashtopay"></span></b>
            </div>
            <div class="add-work-done-poppup-contant">
                <div class="add-work-done-poppup-textbox-cc">
                    <div class="add-work-done-poppup-textbox-box">
                        ...
                        <div class="main_container_track_order_list inner-textbox-cc" style="margin-top:10px;margin-bottom:0">
                           ...
                           <table >
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 10%;padding: 1%;">2000</td>
                                    <td style="width: 2%">*</td>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td style="width: 10%;padding: 1%;">500</td>
                                        <td style="width: 2%">*</td>
                                    ...
                                    <tr>
                                        <tr>
                                            <td style="width: 10%;padding: 1%;">200</td>
                                            <td style="width: 2%">*</td>
                                        ...
                                        <tr>
                                            <tr>
                                                <td style="width: 10%;padding: 1%;">100</td>
                                                <td style="width: 2%">*</td>
                                            ...
                                            <tr> 
                                                <tr>
                                                    <td style="width: 10%;padding: 1%;">50</td>
                                                    <td style="width: 2%">*</td>
                                                ...
                                                <tr>
                                                    <tr>
                                                        <td style="width: 10%;padding: 1%;">20</td>
                                                        <td style="width: 2%">*</td>
                                                    ...
                                                    <tr>
                                                        <tr>
                                                            <td style="width: 10%;padding: 1%;">10</td>
                                                            <td style="width: 2%">*</td>
                                                        ...
                                                        <tr>
                                                            <tr>
                                                                <td style="width: 10%;padding: 1%;">Change</td>
                                                                <td style="width: 2%"></td>
                                                        ...
                                                        <tr> 
                                                            ...
                                                            <tr> -->
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 2%">=</td>
                                                                    <td style="width: 10%"><b><span  id="finalvalue">0</span></b></td>
                                                                <tr> 
                                                                    <tr>
                                                                        <td style="width: 10%;padding: 1%;"></td>
                                                                        <td style="width: 2%"></td>
                                                                        <td style="width: 10%"><b>Balance</b></td>
                                                                        <td style="width: 2%">=</td>
                                                                        <td style="width: 10%"><b><span  id="finalbal">0</span></b></td>
                                                                    <tr> 
                            </tbody>
                           </table>
 ...
 $(document).ready(function() {
    $('#date_pay').datepicker({
        ...
        function load_payhistorylist()
        {
            ...
            if($('#tranc_typefil').val() != '')
            transctype=$('#tranc_typefil').val();
            else
            transctype='';

            var data={"staffname":staffname,"datecheck":datecheck,"transctype":transctype};
            $.ajax({
                    method: "get",
                    url : "load_paymenttable_history", 
                    data:data,                  
                    cache : false,
                    crossDomain : true,
                    async : false,
