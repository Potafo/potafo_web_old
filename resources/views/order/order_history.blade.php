...
<!--                <div class="filter_box_section">FILTER</div>-->
                   <div class="filter_text_box_row">
                       ...
                       <div class="main_inner_class_track" style="width: 13%;">
                          <div class="group">
                             <div style="position: relative">
                       ...
                       <div class="main_inner_class_track" style="width: 15%;">
                            <div class="group">
                                <div style="position: relative">
                                    ...
                                    <select class="form-control" id="order_cat_filter" >
               ...
               @foreach($all_orders as $orders)
                @if($orders->current_status == 'P')  
                    <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="current_order_box new_order_1" onclick="return view_pop_up('{{$orders->order_number}}','{{$orders->rest_id}}','{{$orders->customer_id}}');">
                 ...
                 @elseif($orders->current_status == 'C')
                    <div class="col-md-3 col-sm-6 col-xs-12 @if(timediff($orders->time) == 'Y')delayed_order @endif">
                        <div class="current_order_box near_delivery_1" onclick="return view_pop_up('{{$orders->order_number}}','{{$orders->rest_id}}','{{$orders->customer_id}}');">
                 ...
                 @elseif($orders->current_status == 'OP')
                    <div class="col-md-3 col-sm-6 col-xs-12 @if(timediff($orders->time) == 'Y')delayed_order @endif">
                         <div class="current_order_box new_pick_up" onclick="return view_pop_up('{{$orders->order_number}}','{{$orders->rest_id}}','{{$orders->customer_id}}');">
                 ...
                 @elseif($orders->current_status == 'D')
                    <div class="col-md-3 col-sm-6 col-xs-12">
                         <div class="current_order_box new_deliverd" onclick="return view_pop_up('{{$orders->order_number}}','{{$orders->rest_id}}','{{$orders->customer_id}}');">
                 ...
                 @elseif($orders->current_status == 'CA')
                    <div class="col-md-3 col-sm-6 col-xs-12">
                         <div class="current_order_box new_cancelled" onclick="return view_pop_up('{{$orders->order_number}}','{{$orders->rest_id}}','{{$orders->customer_id}}');">
        ...
        $.fn.dataTable.ext.errMode = 'none';     
         ...
         function change_filter()
         {
            $("#full_loading").show();
             ...
             var data = {"staffid":staffid,"flt_from":flt_from,"flt_to":flt_to,"order_rest_filter":order_rest_filter,"order_name_filter":order_name_filter,"order_phone_filter":order_phone_filter,"order_status_filter":order_status_filter,"order_number_filter":order_number_filter,"order_cat_filter":order_cat_filter};
             $('#append_table').html(''); 
                
              $.ajax({
                method: "get",
                url: "api/order_history_filter_tables",
                data: data,
    ...
    function view_pop_up(order_number,rest_id,customer_id)
    {
        ...
        var table = $('#example').DataTable();
              ...
              $('#append_division').html('');
                $.ajax({
                method: "get",
                url: "api/view_order_history_details",
                data: data,
                cache: false,
                crossDomain: true,
                async: false,
