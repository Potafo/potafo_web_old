            ...
            <div class="table-responsive">
				...
				<th style="min-width:80px;">Action</th>
                    ...
                    <tr> 
                      ...
                      @endif
                      <td> 
                            <a onclick="return editpack('{{ $item->rest_id }}','{{ $item->sl_no }}','{{$item->item_name}}','{{$item->qty}}','{{$item->offer_item}}','{{ $item->off_qty }}','{{ $item->valid_from }}','{{ $item->valid_to }}','{{ $item->image }}','{{ $item->description }}','{{ $siteUrl }}','{{ $item->type }}','{{ $item->item_type }}')" href="#" class="table-action-btn button_table edit_offer_btn_new edit_pack"><i class="md md-edit"></i></a>
                      </td> 
                    </tr>
                    @endforeach
                    @endif
            ...
            <div class="table-responsive">
				...
				<th style="min-width:80px;">Action</th>
                    ...
                    <tr> 
                      ...
                      @endif
                      <td> 
                          <a onclick="return editindividual('{{ $item->rest_id }}','{{ $item->sl_no }}','{{$item->item_name}}','{{$item->original_rate}}','{{$item->offer_rate}}','{{ $item->valid_from }}','{{ $item->valid_to }}','{{ $item->image }}','{{ $item->description }}','{{ $siteUrl }}','{{ $item->type }}','{{ $item->item_type }}')" href="#" class="table-action-btn button_table edit_offer_btn_new edit_indiv"><i class="md md-edit"></i></a>
                      </td> 
                    </tr>
                    @endforeach
                    @endif
                ...
                <div class="main_inner_class_track" style="width: 26%;">
                          <div class="group">
                             <div style="position: relative">
                                 ...
                                 <input type="text" onkeypress="return isNumberKey(event)" id="amount_above" name="amount_above" class="form-control">
                              </div>
                           </div>
                        </div>
                <div class="main_inner_class_track" style="width: 26%;">
                    ...
                    <div class="main_inner_class_track" style="width: 20%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Offer %*</label>
                                 <input type="text"  onkeypress="return isNumberKey(event)"  id="offer_percent" name="offer_percent" class="form-control">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 20%;">
                        <div class="group">
                            <div style="position: relative">
                                ...
                                <input id="max_amount"  onkeypress="return isNumberKey(event)"  name="max_amount" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 48%;">
                          <div class="group">
                             <div style="position: relative">
                                 ...
                                 <input id="valid_from"  data-date-format = 'yyyy-mm-dd'  name="valid_from" type="text" class="form-control datefield">
                          </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 47%;">
                          <div class="group">
                             <div style="position: relative">
                                 ...
                                 <input id="valid_to" data-date-format = 'yyyy-mm-dd' name="valid_to" type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                ...
                <div class="offer_selected_hd">Items</div>
                    <div class="main_inner_class_track" style="width: 61%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Item*</label>
                                <input type="text" class="form-control" id="item_name" name="item_name" onKeyUp = "return itemnamechange(this.value,'add')">
                    ...
                    <div class="main_inner_class_track" style="width: 17%;">
                        <div class="group">
                            <div style="position: relative">
                                ...
                                <input type="text" id="original_rate" readonly="readonly" name="original_rate" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main_inner_class_track" style="width: 17%;">
                        <div class="group">
                            <div style="position: relative">
                                ...
                                <input type="text" id="offer_rate"  name="offer_rate"  onkeypress="return isNumberKey(event)" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid From*</label>
                                 <input id="item_valid_from" name="item_valid_from"  data-date-format = 'yyyy-mm-dd' type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid To*</label>
                                 <input id="item_valid_to" name="item_valid_to"  data-date-format = 'yyyy-mm-dd' type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    ...
                    <div class="main_inner_class_track" style="width: 45%;"  id="imgdiv">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Image</label>
                                 <input id="item_img" name="item_img" type="file" class="form-control">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 98%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Description</label>
                                 <textarea  id="item_desc" name="item_desc" class="form-control"></textarea>
                              </div>
                           </div>
                        </div>
                </div>
                ...
                <div class="offer_selected_hd">Items</div>
                    <div class="main_inner_class_track" style="width: 34%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Item*</label>
                               <input type="text" class="form-control" id="p_item" name="p_item" onKeyUp = "return itemnamechange(this.value,'pitemadd')">
                    ...
                    <div class="main_inner_class_track" style="width: 11%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Qty*</label>
                                <input type="text" name="p_qty" id="p_qty" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 34%;">
                        <div class="group">
                            <div style="position: relative">
                                ...
                                <input type="text" class="form-control" name="p_off_item" id="p_off_item" onKeyUp = "return itemnamechange(this.value,'pofferadd')">
                    ...
                    <div class="main_inner_class_track" style="width: 12%;">
                        <div class="group">
                            <div style="position: relative">
                                ...
                                <input type="text" name="p_off_qty" id="p_off_qty" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid From*</label>
                                 <input name="p_valid_from" id="p_valid_from" data-date-format = 'yyyy-mm-dd' type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid To*</label>
                                 <input name="p_valid_to" id="p_valid_to" data-date-format = 'yyyy-mm-dd' type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 45%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Image</label>
                                 <input id="p_img" name="p_img" type="file" class="form-control">
                              </div>
                           </div>
                        </div>
                    ...
                    <div class="main_inner_class_track" style="width: 98%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Description</label>
                                 <textarea name="p_desc" id="p_desc" class="form-control"></textarea>
                              </div>
                           </div>
                        </div>
                </div>
            ...
            <div class="restaurant_more_detail_row" style="margin-bottom:-18px">
                ...
                <div class="main_inner_class_track" style="width: 26%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Amount Above*</label>
                                 <input type="text" onkeypress="return isNumberKey(event)" id="edamount_above" name="edamount_above" class="form-control">
                              </div>
                           </div>
                        </div>
                <div class="main_inner_class_track" style="width: 26%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Offer Name*</label>
                                 <input type="text"  id="edoffer_name" name="edoffer_name" class="form-control">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 20%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Offer %*</label>
                                 <input type="text"  onkeypress="return isNumberKey(event)"  id="edoffer_percent" name="edoffer_percent" class="form-control">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 20%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Max Amount*</label>
                                <input id="edmax_amount"  onkeypress="return isNumberKey(event)"  name="edmax_amount" type="text" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 26%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid From*</label>
                                <input id="edvalid_from"  data-date-format = 'yyyy-mm-dd' name="edvalid_from" type="text" class="form-control datefield">
                             </div>
                           </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 27%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid To*</label>
                                 <input id="edvalid_to" data-date-format = 'yyyy-mm-dd' name="edvalid_to" type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="main_inner_class_track" style="width: 40%;">
                          <div class="group">
                             <div style="position: relative" id="imgdiv">
                                 ...
                                 <input id="edimg" name="edimg" type="file" class="form-control">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 97%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Description*</label>
                                 <textarea id="eddescription" name="eddescription" class="form-control"></textarea>
                              </div>
                           </div>
                        </div>
                    </div>
                ...
                <div class="offer_selected_hd">Items</div>
                    <div class="main_inner_class_track" style="width: 61%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Item*</label>
                                <input type="text" class="form-control" id="editem_name" readonly="readonly" name="editem_name" onKeyUp = "return itemnamechange(this.value,'edit')">
                    ...
                    <div class="main_inner_class_track" style="width: 17%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Orginal Rate*</label>
                                <input type="text" id="edoriginal_rate" readonly="readonly" name="edoriginal_rate" class="form-control">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="main_inner_class_track" style="width: 17%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Offer Rate*</label>
                                <input type="text" id="edoffer_rate"  name="edoffer_rate"  onkeypress="return isNumberKey(event)" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid From*</label>
                                 <input id="editem_valid_from" name="editem_valid_from"  data-date-format = 'yyyy-mm-dd' type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid To*</label>
                                 <input id="editem_valid_to" name="editem_valid_to"  data-date-format = 'yyyy-mm-dd' type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    ...
                    <div class="main_inner_class_track" style="width: 45%;"  id="imgdiv">
                          <div class="group">
                             <div style="position: relative">
                                 ...
                                 <input id="editem_img" name="editem_img" type="file" class="form-control">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 98%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Description</label>
                                 <textarea  id="editem_desc" name="editem_desc" class="form-control"></textarea>
                              </div>
                           </div>
                        </div>
                  </div>
                ...
                <div class="offer_selected_hd">Items</div>
                    <div class="main_inner_class_track" style="width: 34%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Item*</label>
                               <input type="text" class="form-control" id="edp_item" name="edp_item" onKeyUp = "return itemnamechange(this.value,'pitemedit')" >
                    ...
                    <div class="main_inner_class_track" style="width: 11%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Qty*</label>
                                <input type="text" name="edp_qty" id="edp_qty" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 34%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Offer Item*</label>
                                <input type="text" class="form-control" name="edp_off_item" id="edp_off_item" onKeyUp = "return itemnamechange(this.value,'pofferedit')">
                    ...
                    <div class="main_inner_class_track" style="width: 12%;">
                        <div class="group">
                            <div style="position: relative">
                                <label>Offer Qty*</label>
                                <input type="text" name="edp_off_qty" id="edp_off_qty" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid From*</label>
                                 <input name="edp_valid_from" data-date-format = 'yyyy-mm-dd' id="edp_valid_from" type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 25%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Valid To*</label>
                                 <input name="edp_valid_to" data-date-format = 'yyyy-mm-dd'  id="edp_valid_to" type="text" class="form-control datefield">
                              </div>
                           </div>
                        </div>
                    <div class="main_inner_class_track" style="width: 45%;">
                          <div class="group">
                             <div style="position: relative">
                                 ...
                                 <input id="edp_img" name="edp_img" type="file" class="form-control">
                              </div>
                           </div>
                        </div>
                    ...
                    <div class="main_inner_class_track" style="width: 98%;">
                          <div class="group">
                             <div style="position: relative">
                                  <label>Description</label>
                                 <textarea name="edp_desc" id="edp_desc" class="form-control"></textarea>
                              </div>
                           </div>
                        </div>
                </div>
    ...
    add_offer();
     ...
     function add_offer()
     {
      ...
      if(offer_type.val() == 'B')
      {
          ...
          var date2 = secondDate.split("-").reverse().join("-");alert(date2);
          var date1 = firstDate.split("-").reverse().join("-");alert(date1);
...
function editindividual(rid,slno,item_name,original_rate,offer_rate,valid_frm,valid_to,image,desc,url,type,item_type)
{
         $("#edres_id").val(rid);
         $("#edslno").val(slno);
...
function editpack(rid,slno,item_name,qty,offer_item,off_qty,valid_frm,valid_to,image,desc,url,type,item_type)
{
         $("#edres_id").val(rid);
         $("#edslno").val(slno);
